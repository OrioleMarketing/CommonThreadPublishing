...
export const books: Book[] = [
  {
    ...
    format: 'print',
    genre: ['fiction'],
    coverImage: 'https://store.commonthreadpublishing.com/cdn/shop/files/DividedNation_Cover_Front.jpg',
  ...
  },
  {
    ...
    format: 'print',
    genre: ['fiction'],
    coverImage: 'https://store.commonthreadpublishing.com/cdn/shop/files/DividedTogether_Cover_Front.jpg',
  ...
  },
  {
    ...
    coverImage: 'https://store.commonthreadpublishing.com/cdn/shop/files/PowerFromOnHigh_Cover_Front.jpg',
  ...
  },
  {
    ...
    coverImage: 'https://store.commonthreadpublishing.com/cdn/shop/files/TheBibleFinallyMakesSense_Cover_Front.jpg',
  ...
  },
  {
    ...
    coverImage: 'https://store.commonthreadpublishing.com/cdn/shop/files/JohnstownTragedy_Cover_Front.jpg',
  ...
  },
  {
    ...
    format: 'print',
    genre: ['fiction'],
    coverImage: 'https://store.commonthreadpublishing.com/cdn/shop/files/ThePrayers_Book3_Cover_Front.jpg',
  ...
  },
  {
    ...
    format: 'print',
    genre: ['devotional'],
    coverImage: 'https://store.commonthreadpublishing.com/cdn/shop/files/ThinkingAboutPrayer_Cover_Front.jpg',
